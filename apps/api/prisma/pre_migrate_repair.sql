...
-- This script must also be safe on a fresh database where the tables do not exist yet.

DO $$
BEGIN
  IF to_regclass('public."GameSession"') IS NOT NULL THEN
...
DO $$
BEGIN
  IF to_regclass('public."CombatSession"') IS NOT NULL THEN
