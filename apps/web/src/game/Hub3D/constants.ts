...
export const CAMERA_ZOOM_MOBILE = 22;
export const CAMERA_ZOOM_MIN_MOBILE = 14;
export const CAMERA_ZOOM_MAX_MOBILE = 36;
export const CAMERA_ROTATE_SENSITIVITY_MOBILE = 0.0035;
export const CAMERA_DRAG_THRESHOLD_PX_MOBILE = 8;
